	...
	<div class="container-fluid text-center">
      ...
      <p><a href="#">Link</a></p> -->
			...
			<div class="col-sm-8 text-left">
				...
				<br> <input type="text" id="txtBusca" class="dados-cadastro" placeholder="Digite aqui um valor para filtrar..." />
				<br> <br>
				<c:if test="${usuarioLogado.isAdm ==  'TRUE'}">
								...
								<div class="row espacador">
									<li>
										...
										<div class="col-sm-6 text-right">
											<a href="entrada?acao=MostraUsuario&id=${usuario.id}"><button type="button" class="botao-novo">Editar\Mostrar
													Usuário</button></a> <a href="entrada?acao=RemoveUsuario&id=${usuario.id}"><button type="button" class="botao-novo">Remover
													Usuário</button></a> <br>
										</div>
									</li>
								</div>
