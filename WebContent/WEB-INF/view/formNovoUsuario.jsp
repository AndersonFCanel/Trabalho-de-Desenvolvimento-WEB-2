				...
				<c:if test="${usuarioLogado.isAdm ==  'TRUE'}">
					<form action="${linkEntradaServlet}" method="post">
						...
						<input type="text" name="nome" value="${usuario.nome}"
							required="required" class="dados-cadastro"  />
						 <label class="descricao" for="sobrenome">Sobrenome</label>
						 <input type="text"
							name="sobrenome" value="${usuario.sobrenome}" required="required" class="dados-cadastro" >
						<label class="descricao" for="endereco"> Endereço</label>
						<input type="text" name="endereco"
							value="${usuario.endereco}" required="required" class="dados-cadastro" >
						...
						<input type="password"
							name="senha" value="${usuario.senha}" required="required" class="dados-cadastro" >
						<label class="descricao" for="senha">Confirma Senha</label>
						<input type="password" name="confirmaSenha"
							value="" required="required" class="dados-cadastro" > <br>
						<label for="ehAdm">Usuario possui perfil administrador:</label><br>
					    <input type="radio" name="ehAdm" value="1"
						...
						<input type="date" name="data" class="dados-cadastro" 	required="required" />
